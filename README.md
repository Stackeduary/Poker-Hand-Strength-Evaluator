...
Your need to implement the `process` method in the [solver.py](solver/solver.py) file.
...
and [five_card_draw_solver_test.py](test/five_card_draw_solver_test.py) should pass. There will also be other tests run after you submit your solver.
...
Once you are finished with the task, please click the `Complete task` link on <a href="https://app.codescreen.com/#/codescreentest61e7d115a0dbec040585765c" target="_blank">this screen</a>.